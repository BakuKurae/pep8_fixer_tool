...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QRect(130, 30, 151, 20))
        self.label.setAlignment(Qt.AlignCenter)
        self.browseButton = QPushButton(self.centralwidget)
        self.browseButton.setObjectName(u"browseButton")
        self.browseButton.setGeometry(QRect(10, 10, 62, 19))
        ...
        self.lineEdit.setGeometry(QRect(80, 10, 241, 20))
        ...
        self.progressBar.setGeometry(QRect(82, 270, 241, 20))
        self.progressBar.setValue(24)
        self.progressBar.setAlignment(Qt.AlignCenter)
        self.listView = QListView(self.centralwidget)
        self.listView.setObjectName(u"listView")
        self.listView.setGeometry(QRect(10, 50, 381, 211))
